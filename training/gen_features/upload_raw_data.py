...
from config import raw_data_dir, project_id, dataset_id, bucket_name
...
def load_to_BQ(table_id):
    ...
    local_src_path = Path(raw_data_dir) / f"{table_id}.json"
    ...
    t = BigQuery(project_id=project_id,
                 ...
                 table_id=table_id,
                 schema_json_path=f'./training/gen_features/schemas/{table_id}.json',
                 logger=logger)
